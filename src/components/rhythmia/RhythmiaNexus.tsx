...
import styles from './RhythmiaNexus.module.css';

type GameType = 'vanilla' | 'multiplayer' | 'modded' | null;
    ...
    <div className={styles.wrapper}>
        ...
        <div className={styles.container}>
          ...
          <main className={styles.main}>
            ...
            <div className={styles.serverGrid}>
              {/* Vanilla Server */}
              <div className={`${styles.serverCard} ${styles.vanilla}`} onClick={() => launchGame('vanilla')}>
              ...
              {/* Multiplayer Server */}
              <div className={`${styles.serverCard} ${styles.multiplayer}`} onClick={() => launchGame('multiplayer')}>
                <span className={`${styles.cardBadge} ${styles.newBadge}`}>🔥 NEW</span>
              ...
              {/* Modded Server */}
              <div className={`${styles.serverCard} ${styles.modded}`} onClick={() => launchGame('modded')}>
      ...
      {activeGame === 'vanilla' && (
        <div className={`${styles.gameContainer} ${styles.active}`}>
          ...
          <iframe className={styles.gameFrame} title="Vanilla Game" />
        </div>
      )}

      {activeGame === 'multiplayer' && (
        <div className={`${styles.gameContainer} ${styles.active}`}>
          <div className={styles.gameHeader}>
          ...
          <iframe className={styles.gameFrame} title="Multiplayer Game" />
        </div>
      )}
      ...
      {activeGame === 'modded' && (
        <div className={`${styles.gameContainer} ${styles.active}`}>
          ...
          <iframe className={styles.gameFrame} title="Modded Game" />
        </div>
      )}
    </div>
  );
