...
export default function MessengerUI() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      author: HOMEPAGE_CONFIG.owner.name,
      content: HOMEPAGE_CONFIG.owner.greeting,
      timestamp: new Date(),
      isOwner: true,
    },
  ]);
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      ...
      if (result.url) {
        ...
        // Add bot response for unknown intent
        setTimeout(() => {
  ...
  return (
    <div className="w-full h-screen flex">
      ...
      <div className="hidden md:flex flex-col gap-2 w-20 bg-[#1e1f22] p-3">
        ...
        {/* Discord server */}
        <motion.a
          href={HOMEPAGE_CONFIG.socials.discord.invite}
          target="_blank"
        ...
        <div className="p-4">
          <div className="flex items-center gap-2 px-4 py-3 bg-[#383a40] rounded-lg">
            <input
              ...
              placeholder={`Message ${HOMEPAGE_CONFIG.owner.name}`}
