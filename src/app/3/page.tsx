    ...
    <>
      ...
      <main className="grid grid-cols-12 grid-rows-6 grid-flow-row items-center justify-center h-screen bg-black">
          ...
          <div className="grid p-4 rounded-xl text-base font-black text-white grid-rows-5 grid-cols-5 grid-flow-row row-start-3 col-start-6 row-span-2 col-span-2 place-items-center">
            ...
            <motion.a href="https://github.com/Azuretier" className="fade-up grid place-items-center gap-3 text-white border-2 border-black outline outline-2 outline-gray-400 outline-offset-0 rounded-lg">
              <FaGithub size={24} />
            </motion.a>
            <motion.a href="https://discord.gg/XkwSarHyQm" className="fade-up grid place-items-center gap-3 row-start-3 text-indigo-400 border-2 border-black outline outline-2 outline-indigo-400 outline-offset-0 rounded-lg">
              <FaDiscord size={24} />
            </motion.a>
            <motion.a href="https://youtube.com/@Azuret" className="fade-up grid place-items-center gap-3 row-start-3 text-red-500 border-2 border-black outline outline-2 outline-red-500 outline-offset-0 rounded-lg">
              <FaYoutube size={24} />
            </motion.a>
          </div>
      </main>
